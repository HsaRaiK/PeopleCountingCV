# Object detection - YOLO - OpenCV - Version 4 
...
filepath = []
arr_ppl = []
number_of_runs = int(input("Please enter how many pictures you would like to prcoess \n"))
...
for x in filepath:
    ...
    with open(aclasses, 'r') as f:
        classes = [line.strip() for line in f.readlines()]

    COLORS = np.random.uniform(0, 255, size=(len(classes), 3))

    net = cv2.dnn.readNet(aweights, aconfig)
    ...
    #print(len(arr_ppl))
    print("Pleople found : "+str(ppl_cntr))
